...
// Tipo de contrato y sus "variables"
#[derive(Clone)]
#[contracttype]
pub enum DataKey {
    Deadline,
...
// Diferentes estados que puede tener el contrato
...
// Revisar que hace esto con mas profundidad
...
// Obtener el timestamp del ledger
...
// Obtener cuando empezo el contrato
...
// Obtener el deposito del usuario
...
// Settear el deposito del usuario
